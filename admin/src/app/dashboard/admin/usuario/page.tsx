        ...
        >
          ...
          <div>
            ...
            <div className="sm:w-1/3 sm:ml-4">
              ...
              <select 
                className="block w-full border border-gray-300 rounded-md bg-gray-100 mt-2 pl-3 pr-3 py-1.5 text-base text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                id="genero" 
                name="genero" 
